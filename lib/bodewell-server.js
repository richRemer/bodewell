 ...
 * @returns {Promise}
 */
Server.prototype.enablePlugin = function(plugin) {
 ...
 * @param {string[]} emails
 */
Server.prototype.updateReports = function(emails) {
 ...
 * @param {string} email
 */
Server.prototype.email = function(email) {
    var updated;
 ...
 * @param {string} email
 */
Server.prototype.quiet = function(email) {
    var updated;
 ...
 * @param {...string} args
 */
Server.prototype.notify = function(args) {
    var app = this,
        sendmail,
        subject, to, msg,
        email,
